            ...
            <div className="Header">
                <header className="header">
                    <div className="container-fluid px-lg-5">
                        <nav className="py-4">
                            <div id="logo">
                                <h1> <a href="index.html"><span className="fa fa-bold"  ></span>ootie</a></h1>
                            </div>
                            ...
                            <Router>
                                <ul className="menu mt-2">
                                    ...
                                    <li>
                                        ...
                                        <a href="/#">Drop Down <span className="fa fa-angle-down"  ></span></a>
                                        <input type="checkbox" id="drop-2" />
                                        <ul>
                                            <li><Link to="/blog">Blog</Link></li>
                                            <li><Link to="/shop">Shop</Link></li>
                                            <li><Link to="/single-page">Single Page</Link></li>
                                        </ul>
                                    </li>
